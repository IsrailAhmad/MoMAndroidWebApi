...
namespace EverGreenWebApi.Repository
{
    public class OrderRepository : IOrderRepository
    {
        ...
        //                //GSTvalue = (decimal)product.UnitPrice * (decimal)product.GST / (100 + (decimal)product.GST);
        //                //productprice = (decimal)product.UnitPrice - GSTvalue;                    
        //            }
        //            else
        //            {
        ...
        //            //gstvalue = taxabale_value * (decimal)product.GST / 100;
        //            //productnetvalue = taxabale_value + gstvalue;
